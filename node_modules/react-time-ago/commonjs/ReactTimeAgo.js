...
var TimeAgoCache = new _cache2.default();
function getTimeAgo(preferredLocales, polyfill) {
	...
	return TimeAgoCache.get(key) || TimeAgoCache.put(key, new _javascriptTimeAgo2.default(preferredLocales, { polyfill: polyfill }));
}
