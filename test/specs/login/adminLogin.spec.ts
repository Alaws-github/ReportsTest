...
test.describe('Admin User Authentication @login', () => {
  ...
  test('Should not login the admin user with invalid email and valid password', async ({
    loginPage,
  }) => {
    // Logs in the user
    await loginPage.login(
  ...
  test('Should not login the admin user with valid email and invalid password', async ({
    loginPage,
  }) => {
    // Logs in the user
    await loginPage.login(
  ...
  test('Should not login the admin user with valid email and no password', async ({
    loginPage,
  }) => {
    // Logs in the user
    await loginPage.login(
